        ...
        <div className="flex items-center gap-0 mt-6" style={{ alignItems: "center" }}>
          ...
          <div
            ...
            style={{
              width: "7px",
              height: "26px",
              background: "linear-gradient(180deg, #D4AF37 0%, #C9A136 50%, #B8932F 100%)",
              boxShadow: `
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              `,
              boxShadow: `
                0 8px 20px rgba(120, 53, 15, 0.03),
                0 4px 12px rgba(120, 53, 15, 0.025),
                0 2px 6px rgba(124, 45, 18, 0.02),
                0 1px 3px rgba(180, 83, 9, 0.015),
                inset 0 2px 0 rgba(255, 255, 255, 0.98),
                inset 0 -1px 0 rgba(214, 167, 86, 0.025),
                inset 0 0 20px rgba(255, 248, 237, 0.10)
              `,
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = `
                0 16px 40px rgba(120, 53, 15, 0.05),
                0 10px 28px rgba(120, 53, 15, 0.04),
                0 6px 18px rgba(124, 45, 18, 0.035),
                0 3px 10px rgba(180, 83, 9, 0.025),
                0 0 0 3px rgba(214, 167, 86, 0.09),
                inset 0 2px 0 rgba(255, 255, 255, 0.98),
                inset 0 0 30px rgba(255, 248, 237, 0.15),
                inset 0 0 60px rgba(214, 167, 86, 0.04)
              `;
            ...
            onMouseDown={(e) => {
              e.currentTarget.style.boxShadow = `
                ...
                0 2px 8px rgba(124, 45, 18, 0.03),
                inset 0 3px 8px rgba(120, 53, 15, 0.045),
